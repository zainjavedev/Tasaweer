...
export default function Page() {
  return (
    <div className="mx-auto max-w-xl rounded-2xl border-2 border-white/30 bg-white/60 p-8 text-center shadow-[0_10px_40px_-10px_rgba(0,0,0,0.25)] backdrop-blur">
      <h1 className="text-3xl font-semibold text-black">Admin Dashboard Disabled</h1>
      <p className="mt-4 text-black/70">
        The admin tools previously managed user accounts, but accounts are no longer part of Tasaweers. If you need usage insights, reach out directly.
      </p>
      <div className="mt-6">
        <Link
          href="/"
